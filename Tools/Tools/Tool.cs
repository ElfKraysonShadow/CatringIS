    ...
    public class Tool
    {
        ...
        public void ExportToWord()
        {
           WorkWithWord w = new WorkWithWord();
            w.GenerateClientDocument("ClientBasa.docx");
            MessageBox.Show("Информация сохранена в ClientBasa.docx");
        }

        public void ExportToExcel()
        {
            ExcelPackage.LicenseContext = LicenseContext.NonCommercial;
            WorkToExcel w = new WorkToExcel("ClientBasa.xlsx");
            MessageBox.Show("Информация сохранена в ClientBasa.xlsx");
        }
